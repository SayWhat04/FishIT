export const environment = {
  production: true,
  supabase: {
    url: 'YOUR_PRODUCTION_SUPABASE_URL', // e.g. 'https://abcdefghijklmnopqrst.supabase.co'
    key: 'YOUR_PRODUCTION_SUPABASE_ANON_KEY', // public anon key - safe to include in client code
  }
};
